  ...
  return (
    <>
      ...
      <a
        ...
        className="hidden md:flex fixed bottom-6 right-6 z-50 items-center gap-3 bg-[#25D366] hover:bg-[#128C7E] text-white px-5 py-3.5 rounded-full shadow-2xl shadow-black/20 transition-all duration-300 hover:scale-105"
      >
        <WhatsAppIcon />
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 flex border-t border-white/10 shadow-2xl">
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2.5 bg-[#0F172A] text-white py-4 text-sm font-semibold active:bg-white/10"
        >
          <PhoneIcon />
        ...
        <a
          ...
          rel="noopener noreferrer"
          aria-label="Chat on WhatsApp"
          className="flex-1 flex items-center justify-center gap-2.5 bg-[#25D366] text-white py-4 text-sm font-semibold active:bg-[#128C7E]"
        >
          <WhatsAppIcon />
          <span>WhatsApp</span>
        </a>
      ...
      {/* Mobile spacer so footer isn't obscured by sticky bar */}
